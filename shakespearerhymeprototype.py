...
### sonnet, a list of strings in the form of a sonnet
# produces
### rhymedline, a string
# purpose
### to return the corresponding line from a sonnet
def rhymedline(word):
    index = find_sonnet_index(word)
    if type(index) == str:
        return "No rhyming line found"
    sonnet = all_sonnets[index]
    end_words = []
    for line in sonnet:
        end_words.append(line.split()[-1])
    matches = {}
    uplines = [0, 1, 4, 5, 8, 9]
    downlines = [2, 3, 6, 7, 10, 11]
    for x in uplines:
...
print(rhymedline("day"))
print(rhymedline("thee"))
print(type(rhymedline("day")))
print(rhymedline(1))
print(rhymedline(True))
print(rhymedline("bamboozle"))
